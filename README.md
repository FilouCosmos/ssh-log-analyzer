...
Pour que ce script agisse comme un véritable outil de sécurité actif, il doit tourner en permanence. 
Éditez la crontab de l'utilisateur root (sudo crontab -e) et ajoutez cette ligne pour exécuter l'analyseur toutes les 5 minutes :
